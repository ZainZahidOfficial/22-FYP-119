...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        map.put(techList.get(0), R.drawable.aremv);
        map.put(techList.get(1), R.drawable.bremv);
        map.put(techList.get(2), R.drawable.cremv);
        map.put(techList.get(3), R.drawable.dremv);
        map.put(techList.get(4), R.drawable.eremv);
        map.put(techList.get(5), R.drawable.fremv);
        map.put(techList.get(6), R.drawable.gremv);
        map.put(techList.get(7), R.drawable.hremv);
        map.put(techList.get(8), R.drawable.iremv);
        map.put(techList.get(9), R.drawable.jremv);
        map.put(techList.get(10), R.drawable.kremv);
        map.put(techList.get(11), R.drawable.lremv);
        map.put(techList.get(12), R.drawable.mremv);
        map.put(techList.get(13), R.drawable.nremv);
        map.put(techList.get(14), R.drawable.oremv);
        map.put(techList.get(15), R.drawable.premv);
        map.put(techList.get(16), R.drawable.qremv);
        map.put(techList.get(17), R.drawable.rremv);
        map.put(techList.get(18), R.drawable.sremv);
        map.put(techList.get(19), R.drawable.tremv);
        map.put(techList.get(20), R.drawable.uremv);
        map.put(techList.get(21), R.drawable.vremv);
        map.put(techList.get(22), R.drawable.wremv);
        map.put(techList.get(23), R.drawable.xremv);
        map.put(techList.get(24), R.drawable.yremv);
        map.put(techList.get(25), R.drawable.zremv);
    ...
    public void nextQuestion(View view) {
        ...
        btn4.setBackgroundResource(R.drawable.custom_button);
